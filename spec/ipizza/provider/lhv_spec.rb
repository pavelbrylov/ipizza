...
describe Ipizza::Provider::Lhv do
  ...
  describe '#payment_response' do
    before(:each) do
      ...
      Ipizza::Provider::Lhv.file_cert = File.expand_path('../../../certificates/swedbank_production.pem', __FILE__)
    end
    
    it 'parses and verifies the payment response from bank' do
      Ipizza::Provider::Lhv.new.payment_response(@params).should be_valid
    end
  end
  ...
  describe '#authentication_response' do
    ...
    it 'parses and verifies the authentication response from bank' do
      Ipizza::Provider::Lhv.new.authentication_response(@params).should be_valid
    end
  end
end
